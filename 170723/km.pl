...
%%% Crea length(<lista di centroidi>, K) K clusters 
%%% attorno ai centroidi sulle osservazioni
...
%%% Il core del programma, ricomputa clusters e 
%%% ricalcola i centroidi fino a che la condizione di
%%% terminazione non sia raggiunta
